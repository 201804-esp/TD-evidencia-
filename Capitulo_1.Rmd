...
ggplot(Mode)+
  ...
  scale_fill_manual(values=c("car"= "darkgreen", "carpool"="deeppink", "bus"="darkorange", "rail"="purple"), name="Mode")+
  xlab("Cost")+
theme_bw()
...
grafica_time <- ggplot(Mode)+
  ...
  scale_fill_manual(values=c("car"= "red", "carpool"="green", "bus"="orange", "rail"="purple"), name="Mode")+
  xlab("Time")+
theme_bw()
